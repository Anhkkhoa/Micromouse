...
#define FRONT_RIGHT_EMIT_Pin GPIO_PIN_2
#define FRONT_RIGHT_EMIT_GPIO_Port GPIOA
#define FRONT_RIGHT_READ_Pin GPIO_PIN_3
#define FRONT_RIGHT_READ_GPIO_Port GPIOA
#define DIAG_RIGHT_READ_Pin GPIO_PIN_7
#define DIAG_RIGHT_READ_GPIO_Port GPIOA
#define DIAG_RIGHT_EMIT_Pin GPIO_PIN_4
#define DIAG_RIGHT_EMIT_GPIO_Port GPIOC
#define DIAG_LEFT_EMIT_Pin GPIO_PIN_5
#define DIAG_LEFT_EMIT_GPIO_Port GPIOC
#define DIAG_LEFT_READ_Pin GPIO_PIN_0
#define DIAG_LEFT_READ_GPIO_Port GPIOB
