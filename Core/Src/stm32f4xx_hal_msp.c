...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = FRONT_RIGHT_READ_Pin|DIAG_RIGHT_READ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = DIAG_LEFT_READ_Pin|FRONT_LEFT_READ_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, FRONT_RIGHT_READ_Pin|DIAG_RIGHT_READ_Pin);

    HAL_GPIO_DeInit(GPIOB, DIAG_LEFT_READ_Pin|FRONT_LEFT_READ_Pin);
